...
export class AddDownloadClientType1781049600001 implements MigrationInterface {
  name = 'AddDownloadClientType1781049600001';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_settings" (
                ...
                "download_client_type" varchar DEFAULT ('qbittorrent'),
